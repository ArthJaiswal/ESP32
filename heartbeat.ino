...
//#define PULSEOXIMETER_DEBUGGINGMOD_PULSEDETECT 23
float BPM, SpO2;

/*Put your SSID & Password*/
const char* ssid = "OnePlus 11R";  // Enter SSID here
...
String SendHTML(float BPM, float SpO2) {
  ...
  ptr += "<style>";
  ptr += "body { background-color: #F99B7D; font-family: sans-serif; color: #B04759; font: 14px Helvetica, sans-serif box-sizing: border-box;}";
  ptr += "#page { margin: 20px; background-color: #F99B7D;}";
  ...
  ptr += ".header h3 { font-weight: bold; font-family: Arial, 'sans-serif'; font-size: 17px; color: #B04759; text-align: center;}";
  ...
  ptr += "hr { height: 1px; color: #B04759; background-color: #B04759; border: none;}";
  ptr += "</style>";
  ...
  ptr += "<h1 style=color:black>My Heart Beat and Spo2 level</h1>";
  ptr += "</div>";
